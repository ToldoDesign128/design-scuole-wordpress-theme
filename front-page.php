    ...
    <div class="row justify-content-between">
      ...
      <div id="container-presentazione" class="col-12 col-lg-6">
        ...
        <div id="nostro-istituto">
          ...
          <p>L’istituto Martino Martini è una scuola secondaria di 2° grado situata a Mezzolombardo, facilmente raggiungibile con i mezzi. Nell’istituto sono presenti <strong>9 indirizzi, 5 liceali e 4 tecnici.</strong> Gli indirizzi liceali sono: lo scientifico opzione <strong>scienze applicate</strong>, lo scientifico <strong>sportivo</strong>, lo scientifico internazionale <strong>quadriennale</strong>, il liceo delle <strong>scienze umane</strong> opzione socio-economica e il liceo del <strong>Made in Italy</strong>. Gli indirizzi tecnici sono: l'istituto economico opzione <strong>amministrazione finanza e marketing</strong>, l’istituto economico <strong>internazionale sportivo</strong>, l’istituto tecnologico opzione <strong>trasporti e logistica</strong> e opzione <strong>conduzione del mezzo aereo</strong>. L’orario delle lezioni è su <strong>cinque giorni</strong> (lu-ve) con la <strong>mensa</strong>. Le classi sono dislocate su due sedi: la recente sede di via Perlasca e l’edificio storico di via Filzi.
          </p>
