...
function martini_add_pnrr_metaboxes()
{
    ...
    $cmb_aftercontent->add_field(array(
        ...
        'options'          => array(
            ...
            'erasmus'    => __('Esperienze formative all’estero per studenti e per il personale scolastico - Erasmus +', 'cmb2'),
            'laboratori_ai'    => __('Laboratori di orientamento sull’intelligenza artificiale “Next Generation AI”', 'cmb2'),
            'pcto'    => __('Percorsi  per le Competenze Trasversali e l’Orientamento (PCTO)', 'cmb2'),
        ),
    ));
